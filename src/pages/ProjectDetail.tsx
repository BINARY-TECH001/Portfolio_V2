    ...
    return (
      ...
      >
        <div className="text-center">
          ...
          <span className="text-xs font-mono text-foreground/20">Image not available</span>
        </div>
      </div>
    );
  }
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-x-3 bottom-3 flex items-center gap-2">
         <div className="px-2 py-1 bg-black/60 backdrop-blur-md rounded-sm border border-white/10">
           <span className="text-[9px] uppercase font-bold tracking-widest text-white/60">{alt}</span>
         </div>
      </div>
    </div>
  );
        ...
        <div className="px-6 md:px-12 lg:px-24">
          ...
          <div className="max-w-7xl mx-auto py-20">
            ...
            <motion.div
              ...
              className="mb-20"
            >
              <ProjectImage src={project.heroImage} alt={`${project.title} Overview`} aspect="16/8" />
            </motion.div>
            ...
            >
              <ProjectImage src={project.screenshots?.[0]} alt="Interface Detail" aspect="4/3" />
              <ProjectImage src={project.screenshots?.[1]} alt="Core Feature" aspect="4/3" />
            </motion.div>
